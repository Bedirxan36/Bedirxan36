...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:6a11cb,100:2575fc&height=200&section=header&text=Bedirhan%20Doğan&fontSize=45&fontColor=ffffff&animation=fadeIn&fontAlignY=35" />

<img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&size=22&duration=3000&pause=800&color=7F5AF0&center=true&vCenter=true&width=700&lines=Software+Developer;.+NET+Enthusiast;Clean+Architecture+Advocate;High+Performance+%26+Scalable+Systems" />
...
### 🚀 Software Developer | .NET Specialist | Clean Code Enthusiast  
...
🇹🇷  
Merhaba, ben **Bedirhan Doğan**. 17 yaşında bir yazılım geliştiricisiyim ve özellikle **.NET ekosistemi** üzerinde uzmanlaşmaya odaklanıyorum.  

Temiz mimari prensipleri, sürdürülebilir kod yapıları ve yüksek performanslı sistemler geliştirmeyi öncelik haline getiriyorum.  

Backend servisleri, yönetim panelleri, event-driven sistemler ve ölçeklenebilir uygulamalar geliştiriyorum.

🇬🇧  
Hello, I'm **Bedirhan Doğan**, a 17-year-old software developer focused on mastering the **.NET ecosystem**.  
...
![MediatR](https://img.shields.io/badge/MediatR-5C2D91?style=for-the-badge)
...
- 📚 Mastering Advanced .NET Concepts  
- 🧠 Deep Dive into Distributed Systems  
- ☁️ Exploring Cloud & DevOps  
- 🚀 Building Production-Ready Large Scale Projects  
